...
namespace Com.IsartDigital.Sokoban
{
	public partial class Box : Node2D
	{
        ...
        {
            GameManager.GetInstance().tileMap.SetCell( 1, (Vector2I)(Position/States.DISTANCE_RANGE) + Player.GetInstance().lastDirection/States.DISTANCE_RANGE, 0, GameManager.GetInstance().objectPositionOnTileSet[ObjectChar.BOX]);
            animPlaying = false;
